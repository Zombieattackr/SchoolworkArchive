...
HD_PWD='C:/Users/Hayden/Desktop/ExportBack/CoCO_Studios/twoBitComparator/twoBitComparator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fuller_hayden_studio1.vdi -applog -m64 -messageDb vivado.pb -mode batch -source fuller_hayden_studio1.tcl -notrace
