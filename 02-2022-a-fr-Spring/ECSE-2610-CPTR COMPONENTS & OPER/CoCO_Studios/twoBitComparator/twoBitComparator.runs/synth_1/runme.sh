...
HD_PWD='C:/Users/Hayden/Desktop/ExportBack/CoCO_Studios/twoBitComparator/twoBitComparator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fuller_hayden_studio1.vds -m64 -mode batch -messageDb vivado.pb -notrace -source fuller_hayden_studio1.tcl
