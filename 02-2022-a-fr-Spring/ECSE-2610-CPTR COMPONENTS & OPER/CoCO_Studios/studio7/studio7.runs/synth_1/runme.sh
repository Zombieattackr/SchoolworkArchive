...
HD_PWD='C:/Users/Hayden/Desktop/ExportBack/CoCO_Studios/studio7/studio7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log topdown.vds -m64 -mode batch -messageDb vivado.pb -notrace -source topdown.tcl
