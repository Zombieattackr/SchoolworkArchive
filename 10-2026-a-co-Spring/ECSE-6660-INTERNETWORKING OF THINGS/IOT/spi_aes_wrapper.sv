/*module spi_aes_wrapper (
    ...
    // Add this right before your Main Control Logic always_ff block
    ...
    always_ff @(posedge clk) begin
        ...
        if (reset) begin
            ...
            if (aes_done) begin
                ...
                data_ready <= 1'b1; // Tell the Pi it can read now
            end
            
            // Clear interrupt when Pi starts reading
