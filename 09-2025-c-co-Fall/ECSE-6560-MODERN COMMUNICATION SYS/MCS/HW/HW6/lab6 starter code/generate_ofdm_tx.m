function [ tx_payload_vec]=generate_ofdm_tx(tx_data,pilots, MOD_ORDER, N_SC, CP_LEN, SC_IND_DATA, SC_IND_PILOTS, N_OFDM_SYMS)

% Modulation
tx_syms_mat = qammod(tx_data,MOD_ORDER,'UnitAveragePower',true);
